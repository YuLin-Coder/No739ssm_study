...
<body>
	...
	<div class="loginWraper" style="background-size:100% 100%">
		<div id="loginform" class="loginBox">
			<p style="font-size: 28px;font-weight: bold;text-align: center;color: white;letter-spacing: 2px;margin-bottom: 30px;">在线学习系统</p>
			<form class="form form-horizontal" action="login/login.action" name="myform" method="post"
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8">
						<input type="radio" id="role" name="role" value="系统用户" checked>系统用户 &nbsp;&nbsp;&nbsp;&nbsp; <input type="radio"
							id="role" name="role" value="教师用户" >教师用户
					</div>
				</div>
				<div class="row cl">
